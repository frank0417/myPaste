...
把下面 6 张按顺序上传到 App Store Connect → macOS 截图位。每张只讲一件事，图上是**真实产品界面** + 大字标题。每张图三个语言版本（`-zh` / `-zh-Hant` / `-en`）。

### 01 英雄图 — 复制过的，都还在

<img alt="01 英雄图" src="app-store/screenshots/01-hero-zh-2560x1600.png" />
...
**卖点**  
第一眼不是功能列表，是真实的底部货架：链接 / 代码 / 文本 / 颜色 / 截图卡片一字排开，让人认出这是自己的工作流。

---

### 02 快捷键 — 按一下，它就来了

<img alt="02 快捷键" src="app-store/screenshots/02-hotkey-zh-2560x1600.png" />

**屏幕标题**  
按一下，它就来了。

**商店配文**  
底部货架、主窗口、截图各有独立快捷键。录下即刻生效。

**卖点**  
手不离开键盘。真实设置页 + 三颗键帽，比软件设置页更想按下去。强调「回车粘贴到正在用的 App」。

---

### 03 截图 — 截图像发一条消息

<img alt="03 截图标注" src="app-store/screenshots/03-screenshot-zh-2560x1600.png" />
...
**卖点**  
对标微信/QQ 截图手感，这是免费剪贴板没有的。真实标注工具条，图标 + 悬停提示，界面干净。

---

### 04 识字 — 图里的字，也能搜

<img alt="04 识别文字" src="app-store/screenshots/04-ocr-zh-2560x1600.png" />
...
**卖点**  
真实的识别结果卡片，可选中复制。强调 **本机、不上传**。

---

### 05 搜索 — 不用整理，它自己认得

<img alt="05 搜索分类" src="app-store/screenshots/05-search-zh-2560x1600.png" />

**屏幕标题**  
不用整理，它自己认得。

**商店配文**  
链接、代码、颜色、文件自动打标。搜索标题、正文、来源应用。

**卖点**  
真实主窗口三栏。搜索高亮命中，让人感到「我找得到」。

---

### 06 收藏 — 重要的，留下来

<img alt="06 收藏与隐私" src="app-store/screenshots/06-keep-zh-2560x1600.png" />
...
**卖点**  
真实详情页 + 三条短句：标签、自动清理、无广告无追踪。把隐私讲成质感。
